...
const BusinessCardDetail = () => {
  ...
  const product = businessCards.find((p) => p.id === parseInt(id));
  ...
  if (!product) {
    return <div className="product-not-found">Business Card not found. <Link to="/businesscard">Return to Business Cards</Link></div>;
  }
        ...
        <div className="pd-hero">
          ...
          <div className="pd-hero-info">
            ...
            <ul className="pd-features-list">
              <li>Premium quality {product.type.toLowerCase()} visiting card.</li>
              <li>Standard size: 89x51mm.</li>
              <li>Choose from Multiple Paper options</li>
              <li>Select from Matte or Gloss lamination options</li>
              <li>Select straight or round edges</li>
              <li>Preview your designs before placing order</li>
            </ul>
        ...
        return (
          <div style={{
            ...
            <div style={{ padding: '10px', backgroundColor: '#1c1c1e', display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
              <span style={{ color: '#fff', flex: 1, marginLeft: '10px', fontWeight: 'bold', fontFamily: 'sans-serif' }}>Design Your Business Card</span>
              <button 

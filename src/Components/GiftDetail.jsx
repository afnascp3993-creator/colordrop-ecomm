...
const GiftDetail = () => {
  ...
  const product = gifts.find((p) => p.id === parseInt(id));
  ...
  if (!product) {
    return <div className="product-not-found">Gift not found. <Link to="/gifts">Return to Gifts</Link></div>;
  }
        ...
        <div className="pd-hero">
          ...
          <div className="pd-hero-info">
            ...
            <ul className="pd-features-list">
              <li>Premium quality customized {product.type.toLowerCase()}.</li>
              <li>Perfect for personal use and corporate gifting.</li>
              <li>High-quality materials with elegant finishing.</li>
              <li>Durable and long-lasting print quality.</li>
              <li>Personalize with your own name, logo, or message.</li>
              <li>Preview your custom design before placing the order.</li>
            </ul>
            ...
            <div className="pd-price-shipping">
              <div className="price-block">
                ...
                <span className="unit">per piece</span>
              </div>
        ...
        return (
          <div style={{
            ...
            <div style={{ padding: '10px', backgroundColor: '#1c1c1e', display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
              <span style={{ color: '#fff', flex: 1, marginLeft: '10px', fontWeight: 'bold', fontFamily: 'sans-serif' }}>Design Your Custom Gift</span>
              <button 
